...
Lists all available API endpoints, request formats, example responses, and error responses.
  ...
  "data": [
    {
        ...
        "shortName": "1D",
        "featureCount": 280,
        "description": "Features extracted from nucleotide sequences"
    }
  ],
  "error": null
}
...
```json
{
    ...
    "data": {
        "featureSetId": 6,
        "name": "Secondary and Tertiary Features",
        "shortName": "2D+3D",
        "featureCount": 115,
        "description": "Features extracted from secondary and tertiary structures"
    },
    "error": null
}
```
